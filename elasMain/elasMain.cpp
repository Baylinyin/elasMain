// elasMain.cpp : Defines the entry point for the console application.
//
...
//int png2pfm(CByteImage im, const char* file)
//{
//	//try {
//	int quiet = 0;
//	//int argn = 1;
...
//	//CByteImage im;
//	ReadImageVerb (im, file, !quiet);
//	im = ConvertToGray(im);
//	WriteImageVerb(im, file, !quiet);
//	//	} else
...
int main (void/*int argc, char** argv*/) 
{
 ...
 //   }
    ...
    const char *file1 = "im0.pgm";//argv[1];
    const char *file2 = "im1.pgm";//argv[2];
    const char *outfile = "teddy.pfm";
    int maxdisp = 70;//atoi(argv[4]);//64
    int no_interp = 0;
 //   if (argc > 5)
